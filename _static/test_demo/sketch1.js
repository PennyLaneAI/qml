...
var sketch0_1 = function(p) {
	...
	bg0_1 = p.loadImage('src/fourier0-1.png');
    }
...
var sketch0_2 = function(p) {
    ...
    p.setup = function() {
	const canvas1 = p.createCanvas(width, height);
	bg0_2 = p.loadImage('src/fourier0-2.png');
	bg0_3 = p.loadImage('src/fourier0-3.png');
    }
...
var sketch1 = function(p) {
    ...
    p.setup = function() {
	const canvas1 = p.createCanvas(width, height);
	bg1_0 = p.loadImage('src/fourier1-0.png');
	bg1_1 = p.loadImage('src/fourier1-1.png');
    }
