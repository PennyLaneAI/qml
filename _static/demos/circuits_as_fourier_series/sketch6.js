...
var sketch13 = function(p) {
	...
	bg13 = p.loadImage('../_static/demos/circuits_as_fourier_series/src/fourier13.png');
    }
...
var sketch14_5 = function(p) {
    ...
    p.setup = function() {
	const canvas1 = p.createCanvas(width, height);
	bg14_5 = p.loadImage('../_static/demos/circuits_as_fourier_series/src/fourier14_5.png');
    }
