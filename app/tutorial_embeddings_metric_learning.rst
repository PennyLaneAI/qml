...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    Cost for pretrained parameters on training set: 1.8535385750362288e-05
    Cost for pretrained parameters on validation set: 1.8535385750362288e-05
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** ( 1 minutes  56.770 seconds)
