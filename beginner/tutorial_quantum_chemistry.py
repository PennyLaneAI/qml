...
Electronic structure methods rely on the Born-Oppenheimer approximation :ref:`[1]<References>`,
...
# determinant <https://en.wikipedia.org/wiki/Slater_determinant>`_ [4] that results from occupying
# the lowest-energy molecular orbitals until all electrons in the molecule are accommodated. 
# The way molecular orbitals are occupied matters as they determine the self-consistent field.
#
