.. note::
    ...
    Click :ref:`here <sphx_glr_download_demos_rutorial_barren_plateaus.py>` to download the full example code
.. rst-class:: sphx-glr-example-title

.. _sphx_glr_demos_rutorial_barren_plateaus.py:
...
.. _sphx_glr_download_demos_rutorial_barren_plateaus.py:
...
.. only :: html
 ...
 .. container:: sphx-glr-footer
  ...
  .. container:: sphx-glr-download
     ...
     :download:`Download Python source code: rutorial_barren_plateaus.py <rutorial_barren_plateaus.py>`



  .. container:: sphx-glr-download

     :download:`Download Jupyter notebook: rutorial_barren_plateaus.ipynb <rutorial_barren_plateaus.ipynb>`
