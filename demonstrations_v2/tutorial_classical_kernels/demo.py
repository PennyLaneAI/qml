...
<https://pennylane.ai/qml/demos/tutorial_expressivity_fourier_series>`_.
...
#. `Training and evaluating quantum kernels <https://pennylane.ai/qml/demos/tutorial_kernels_module>`_
#. `Kernel-based training of quantum models with scikit-learn <https://pennylane.ai/qml/demos/tutorial_kernel_based_training>`_
...
# `Quantum Embedding Kernels <pennylane.ai/qml/demos/tutorial_kernels_module>`_).
