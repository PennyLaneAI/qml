...
# Wouldn't it make more sense to study the multipartite entanglement form the point of view of density matrices?
...
v = Q[:,0]
v_pauli_coeffs = [np.dot(v, pv).real for pv in B.T]
