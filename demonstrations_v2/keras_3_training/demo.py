...
import os
os.environ["KERAS_BACKEND"] = "tensorflow" # This can be either JAX, tensorflow, or torch. (tensorflow by default)
...
class QKerasLayer(keras.layers.Layer):
    ...
    def create_circuit(self):
        ...
        self.circuit = qml.QNode(self.serial_quantum_model, dev, diff_method=self.circ_grad_method, interface=self.interface)
