...
key spectroscopy algorithms
using PennyLane's resource `estimator <https://docs.pennylane.ai/en/stable/code/qml_estimator.html>`_ to
determine their logical resource requirements. By benchmarking
