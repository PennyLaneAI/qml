...
While for the smallest molecules, H\ :sub:`2` and HeH\ :sup:`+`, data has been obtained for the minimal basis-set `STO-3G`, the split-valence double-zeta basis set `6-31G`, and the correlation-consistent polarized valence-only basis set `CC-PVDZ`.
For the slightly bigger molecules, He\ :sub:`2` and H\ :sub:`3`\ :sup:`+`, data has been generated for former two basis sets, `STO-3G` and `6-31G`. For the remaining molecules, data is only available for the foemer basis set, `STO-3G`.
The geometries for each molecule are defined by the bond lengths between the atoms, with the available bondlengths given by some `K` equispaced values within the ranges given in the table below, depending on the number of qubits `N` required for
simulating it with the chosen basis set. In general, `K` is `41` and `11`, for :math:`N \in [4, 16]` and :math:`N \in [16, 20]`, respectively. In addition to these, we also include data for the optimal ground-state geometry of each molecule. 
For the molecules with :math:`N \in [24, 30]`, we consider only optimal ground-state geometries and are able to provide only non-VQE data currently. We summarise all of this information for all the molecules in the table below.
...
.. rst-class:: docstable
    ...
    +==============================+==============================+==============+===========================================================================+============================================================================+
    | H\ :math:`_2`                | | STO\ :math:`\text{-}`\3G / | 4 / 8 / 20   | | H\ :math:`_A-`\ H\ :math:`_B` :math:`\in\ [0.5, 2.1, 41]` Å             | H\ :math:`_A-`\ H\ :math:`_B = 0.742` Å                                    |
    |                              | | 6\ :math:`\text{-}`\31G    |              | |                                                                         |                                                                            |   
    |                              | | CC\ :math:`\text{-}`\PVDZ  |              | | H\ :math:`_A-`\ H\ :math:`_B` :math:`\in\ [0.5, 2.5, 11]` Å             |                                                                            |   
    +------------------------------+------------------------------+--------------+---------------------------------------------------------------------------+----------------------------------------------------------------------------+
    | HeH\ :math:`^+`              | | STO\ :math:`\text{-}`\3G / | 4 / 8 / 20   | | He\ :math:`-`\ H :math:`\in\ [0.5, 2.1, 41]` Å                          | He\ :math:`-`\ H\ :math:`= 0.775` Å                                        |
    |                              | | 6\ :math:`\text{-}`\31G    |              |                                                                           |                                                                            |           
    |                              | | CC\ :math:`\text{-}`\PVDZ  |              | | He\ :math:`-`\ H :math:`\in\ [0.5, 2.5, 11]` Å                          |                                                                            |   
    +------------------------------+------------------------------+--------------+---------------------------------------------------------------------------+----------------------------------------------------------------------------+
    ...
    |                              |                              |              | | :math:`\measuredangle` CCH :math:`= 121.5^{\circ}`                      | | :math:`\measuredangle` CCH :math:`= 121.5^{\circ}`                       |
    +------------------------------+------------------------------+--------------+---------------------------------------------------------------------------+----------------------------------------------------------------------------+
    | N\ :math:`_2`\ H\ :math:`_4` | STO\ :math:`\text{-}`\3G     | 28           | | N\ :math:`_A-`\ N\ :math:`_B` :math:`= 1.446` Å,                        | | N\ :math:`_A-`\ N\ :math:`_B` :math:`= 1.446` Å,                         |
    |                              |                              |              | | :math:`\measuredangle` NNH :math:`= 107.2^{\circ}`                      | | :math:`\measuredangle` NNH :math:`= 107.2^{\circ}`                       |
    +------------------------------+------------------------------+--------------+---------------------------------------------------------------------------+----------------------------------------------------------------------------+
    | C\ :math:`_2`\ H\ :math:`_6` | STO\ :math:`\text{-}`\3G     | 30           | | C\ :math:`_A-`\ C\ :math:`_B` :math:`= 1.535` Å,                        | | C\ :math:`_A-`\ C\ :math:`_B` :math:`= 1.535` Å,                         |
    |                              |                              |              | | :math:`\measuredangle` CCH :math:`= 111.2^{\circ}`                      | | :math:`\measuredangle` CCH :math:`= 111.2^{\circ}`                       |
    +------------------------------+------------------------------+--------------+---------------------------------------------------------------------------+----------------------------------------------------------------------------+
    | CO\ :math:`_2`               | STO\ :math:`\text{-}`\3G     | 30           | | C\ :math:`-`\ O\ :math:`= 1.162` Å,                                     | | C\ :math:`-`\ O\ :math:`= 1.162` Å,                                      |
    |                              |                              |              | | :math:`\measuredangle` OCO :math:`= 180^{\circ}`                        | | :math:`\measuredangle` OCO :math:`= 180^{\circ}`                         |
    +------------------------------+------------------------------+--------------+---------------------------------------------------------------------------+----------------------------------------------------------------------------+
    | O\ :math:`_3`                | STO\ :math:`\text{-}`\3G     | 30           | | O\ :math:`_A-`\ O\ :math:`_B` :math:`= 1.278` Å,                        | | O\ :math:`_A-`\ O\ :math:`_B` :math:`= 1.278` Å,                         |
    |                              |                              |              | | :math:`\measuredangle` OOO :math:`= 117.2^{\circ}`                      | | :math:`\measuredangle` OOO :math:`= 117.2^{\circ}`                       |
    +------------------------------+------------------------------+--------------+---------------------------------------------------------------------------+----------------------------------------------------------------------------+
...
.. rst-class:: docstable
    ...
    | **Name**                   | **Type**                                                                                                     | **Description**                                                                                                 | 
    +============================+==============================================================================================================+=================================================================================================================+
    | ``qwc_groupings``          | tuple(list[``tensor_like``], list[list[\ :class:`~.pennylane.operation.Operator`]], list[``tensor_like``]])  | List of grouped qubit-wise commuting Hamiltonian terms obtained using :class:`~.pennylane.pauli.meas_groupings` |
    +----------------------------+--------------------------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------+
    | ``basis_rot_groupings``    | tuple(list[``tensor_like``], list[list[\ :class:`~.pennylane.operation.Operator`]], list[``tensor_like``]])  | List of grouped Hamiltonian terms obstained using :class:`~.pennylane.qchem.basis_rotation`                     |
    +----------------------------+--------------------------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------+
