...
.. rst-class:: docstable
    ...
    +---------------------------+-----------------+--------------+----------------------------------------------------------------------------------------------------------+-----------------------+
    | HeH\ :math:`^+`           | STO-3G / 6-31G  | 4 / 8        | He\ :math`--`H :math:`\in\ [0.5, 2.1]`                                                                   |  Still filling values |
    +---------------------------+-----------------+--------------+----------------------------------------------------------------------------------------------------------+-----------------------+
    | H\ :math:`_3^+`           | STO-3G / 6-31G  | 6 / 12       | H\ :math:`_A--`H\ :math:`_B` :math:`\in\ [0.5, 2.1]`, H :math:`_A--`H :math:`_B--`H\ :math:`_C = 60`     |  Fixing math as well  |
    +---------------------------+-----------------+--------------+----------------------------------------------------------------------------------------------------------+-----------------------+
    | H\ :math:`_4`             | STO-3G          | 8            | H :math:`_A--`H :math:`_B` :math:`\in\ [0.5, 1.3]`                                                       |                       |
    +---------------------------+-----------------+--------------+----------------------------------------------------------------------------------------------------------+-----------------------+
    | LiH                       | STO-3G          | 12           | Li\ :math:`--`H :math:`\in\ [0.9, 2.1]`                                                                  |                       |
    +---------------------------+-----------------+--------------+----------------------------------------------------------------------------------------------------------+-----------------------+
    | HF                        | STO-3G          | 12           | H\ :math:`--`F :math:`\in\ [0.5, 2.1]`                                                                   |                       |
    +---------------------------+-----------------+--------------+----------------------------------------------------------------------------------------------------------+-----------------------+
    | OH\ :math:`^-`            | STO-3G          | 12           | [O\ :math:`--`H]\ :math:`^-` :math:`\in\ [0.5, 2.1]`                                                     |                       |
    +---------------------------+-----------------+--------------+----------------------------------------------------------------------------------------------------------+-----------------------+
    | H\ :math:`_6`             | STO-3G          | 12           | H :math:`_A--`H :math:`_B` :math:`\in\ [0.5, 1.3]`                                                       |                       |
    +---------------------------+-----------------+--------------+----------------------------------------------------------------------------------------------------------+-----------------------+
    | BeH\ :math:`_2`           | STO-3G          | 14           | Be\ :math:`--`H :math:`\in\ [0.5, 2.1]`, H :math:`_A` -Be-H :math:`_B = 104.2`                           |                       |
    +---------------------------+-----------------+--------------+----------------------------------------------------------------------------------------------------------+-----------------------+
    | H\ :math:`_2`O            | STO-3G          | 16           | H\ :math:`--`O :math:`\in [0.5, 2.1]`, H :math:`_A` -Be-H :math:`_B = 106.2`                             |                       |
    +---------------------------+-----------------+--------------+----------------------------------------------------------------------------------------------------------+-----------------------+
    | H\ :math:`_8`             | STO-3G          | 16           | H\ :math:`_A--`H\ :math:`_B` :math:`\in\ [0.5, 1.3]`, H :math:`_A` -H :math:`_B` -...-H :math:`_H = 180` |                       |
    +---------------------------+-----------------+--------------+----------------------------------------------------------------------------------------------------------+-----------------------+
    | BH\ :math:`_3`            | STO-3G          | 18           | B\ :math:`--`H :math:`\in\ [0.5, 2.1]`, H :math:`_A` -B-H :math:`_B = 60`                                |                       |
    +---------------------------+-----------------+--------------+----------------------------------------------------------------------------------------------------------+-----------------------+
    | NH\ :math:`_3`            | STO-3G          | 18           | N\ :math:`--`H :math:`\in\ [0.5, 2.1]`, H :math:`_A` -N-H :math:`_B = 60`                                |                       |
    +---------------------------+-----------------+--------------+----------------------------------------------------------------------------------------------------------+-----------------------+
