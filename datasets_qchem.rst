...
.. rst-class:: docstable
    ...
    +------------------------------+------------------------------+--------------+---------------------------------------------------------------------------+----------------------------------------------------------------------------+
    | H\ :math:`_6`                | STO\ :math:`\text{-}`\3G     | 12           | | H\ :math:`_A-`\ H\ :math:`_B` :math:`\in\ [0.5, 1.3, 41]` Å,            |          N/A                                                               |
    |                              |                              |              | | :math:`\measuredangle` HHH :math:`= 180^{\circ}`                        |                                                                            |
    +------------------------------+------------------------------+--------------+---------------------------------------------------------------------------+----------------------------------------------------------------------------+
    ...
    +------------------------------+------------------------------+--------------+---------------------------------------------------------------------------+----------------------------------------------------------------------------+
    | H\ :math:`_7`                | STO\ :math:`\text{-}`\3G     | 14           | | H\ :math:`_A-`\ H\ :math:`_B` :math:`\in\ [0.5, 1.5, 11]` Å,            |          N/A                                                               |
    |                              |                              |              | | :math:`\measuredangle` HHH :math:`= 180^{\circ}`                        |                                                                            |
    +------------------------------+------------------------------+--------------+---------------------------------------------------------------------------+----------------------------------------------------------------------------+
    ...
    +------------------------------+------------------------------+--------------+---------------------------------------------------------------------------+----------------------------------------------------------------------------+
    | H\ :math:`_10`               | STO\ :math:`\text{-}`\3G     | 20           | | H\ :math:`_A-`\ H\ :math:`_B` :math:`= 1.0` Å,                          |          N/A                                                               |
    |                              |                              |              | | :math:`\measuredangle` HHH :math:`= 180^{\circ}`                        |                                                                            |
    +------------------------------+------------------------------+--------------+---------------------------------------------------------------------------+----------------------------------------------------------------------------+
    ...
    |                              |                              |              | | :math:`\measuredangle` OOH :math:`= 100.0^{\circ}`                      | | :math:`\measuredangle` OOH :math:`= 100.0^{\circ}`                       |
    +------------------------------+------------------------------+--------------+---------------------------------------------------------------------------+----------------------------------------------------------------------------+
    | N\ :math:`_2`\ H\ :math:`_2` | STO\ :math:`\text{-}`\3G     | 24           | | N\ :math:`_A-`\ N\ :math:`_B` :math:`= 1.247` Å,                        | | N\ :math:`_A-`\ N\ :math:`_B` :math:`= 1.247` Å,                         |
    |                              |                              |              | | :math:`\measuredangle` NNH :math:`= 106.2^{\circ}`                      | | :math:`\measuredangle` NNH :math:`= 106.2^{\circ}`                       |
    +------------------------------+------------------------------+--------------+---------------------------------------------------------------------------+----------------------------------------------------------------------------+
...
.. rst-class:: docstable
    ...
    | **Name**                   | **Type**                                                                                                     | **Description**                                                                                                 | 
    +============================+==============================================================================================================+=================================================================================================================+
    | ``qwc_groupings``          | tuple(list[``tensor_like``], list[list[\ :class:`~.pennylane.operation.Operator`]], list[``tensor_like``]])  | List of grouped qubit-wise commuting Hamiltonian terms obtained using :func:`~.pennylane.pauli.meas_groupings`  |
    +----------------------------+--------------------------------------------------------------------------------------------------------------+-----------------------------------------------------------------------------------------------------------------+
