...
# and ``stabilizer`` contained in the them. This approach offers a more human-readable
# visualization of tableaus and the following methods assist us in achieving it.
#
