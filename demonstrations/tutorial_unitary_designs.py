...
use a :math:`t`-designs as a shortcut over the full Haar measure to greatly improve
...
[TODO: picture will be updated with some additional solids]
...
configurations become increasingly sphere-like, which makes intuitive sense.
...
so far we have dealt only with real numbers. Surely we will need to include
...
designs. Rather than considering real-valued point, or vectors, on the unit
...
We've seen how both spherical and complex projective designs are sets of evenly
...
# of exact designs [#Dankert]_. It particular, it has been shown that
