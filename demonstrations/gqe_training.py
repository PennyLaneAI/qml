...
generated by the model. Only minor changes would be made to do this type of training however, and is briefly outlined
in the conclusion. We will show that the model gradually better approximates the correct energies and, in turn, 
