...
# :func:`~.meanfield_data` as it is used by the function :func:`generate_hamiltonian`
...
# functions :func:`~.pennylane.SingleExcitationUnitary` and
# :func:`~.pennylane.DoubleExcitationUnitary` contained
...
# act on. The inputs to this function are the indices stored in the ``ph`` and ``pphh`` lists.
