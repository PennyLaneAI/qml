...
#  .. code-block:: none
#
#     0: ──|1⟩─────────────────────────────────────────╭BS(4.318, -3.464)───R(0.0)───────────────Kerr(1.571)──────────────────────────────────────────────────────────────────────────╭BS(1.549, -2.231)────R(0.0)────────────Kerr(1.571)──────────────────────────────────┤ ⟨n⟩
#     1: ──|0⟩─────────────────────╭BS(-0.615, 0.608)──╰BS(4.318, -3.464)──╭BS(-3.639, -0.188)───R(0.0)────────────Kerr(1.571)───────────────────────────────────╭BS(-2.748, -0.137)──╰BS(1.549, -2.231)───╭BS(-1.0, 5.437)───R(0.0)─────────────Kerr(1.571)───────────────┤ ⟨n⟩
#     2: ──|1⟩──╭BS(3.704, 5.265)──╰BS(-0.615, 0.608)──╭BS(0.291, -0.346)──╰BS(-3.639, -0.188)──╭BS(0.552, 5.535)──R(0.0)───────Kerr(1.571)──╭BS(5.226, -5.356)──╰BS(-2.748, -0.137)──╭BS(-4.304, -4.712)──╰BS(-1.0, 5.437)──╭BS(-5.139, 3.768)──R(0.0)───────Kerr(1.571)──┤ ⟨n⟩
#     3: ──|0⟩──╰BS(3.704, 5.265)──────────────────────╰BS(0.291, -0.346)───────────────────────╰BS(0.552, 5.535)──R(0.0)───────Kerr(1.571)──╰BS(5.226, -5.356)───────────────────────╰BS(-4.304, -4.712)────────────────────╰BS(-5.139, 3.768)──R(0.0)───────Kerr(1.571)──┤ ⟨n⟩
#
