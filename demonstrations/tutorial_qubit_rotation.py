...
.. figure:: ../demonstrations/qubit_rotation/quantum_circuit_for_qubit_rotation.png
    :align: center
    :width: 40%
...
#
# .. figure:: ../demonstrations/qubit_rotation/bloch_spheres_showing_a_rotation_of_a_state.png
#     :align: center
#     :width: 70%
#     :target: javascript:void(0);
#
