...
generated by parametrized (layers of) gates and how to derive more general parameter-shift rules
to compute the derivatives of any order of such functions.
...
#
# Let's code this up, again we only get slight complications from the two special evaluations:
