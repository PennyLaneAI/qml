...
# field generated by all other electrons [#pople1977]_. The optimized coefficients

# are precisely what we need to build the second-quantized Hamiltonian.
...
# that act on qubits. This can be done by using
...
##############################################################################
# These functionalities allow users to easily build molecular Hamiltonians.
