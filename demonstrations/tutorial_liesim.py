...
For that, we look at an expectation vector :math:`\vec{e}` made up of expectation values with respect to some transformed initial state :math:`\rho^0`,

.. math:: (\vec{e})_\alpha = \text{tr}\left[ h_\alpha U \rho^0 U^\dagger \right] = \text{tr}\left[ U^\dagger h_\alpha U \rho^0 \right].
...
# initial state |0x0| = I + Z, note that trace function
