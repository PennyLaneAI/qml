...
For a general set of complete functions, to compute the expansion of a function in that set on a classical computer for a discrete number of sampling points would take :math:`\mathcal{O}(N^2)` operations  🐌. 
