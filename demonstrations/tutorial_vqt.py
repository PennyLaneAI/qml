...
# defined as:
# 
# .. math:: \rho_\text{thermal} \ = \ \frac{e^{- H \beta / k_B}}{\text{Tr}(e^{- H \beta / k_B})} \ = \ \frac{e^{- H \beta / k_B}}{Z_{\beta}}
# 
...
# 
# .. math:: S(\rho') \ = \ - \text{Tr} (\rho' \log \rho') \ = \ - \text{Tr} ( U \rho U^{\dagger} \log (U \rho U^{\dagger})) \ = \
...
# 
# .. math:: D(\rho_{\theta \phi} || \rho_{\text{Thermal}}) \ = \ 
