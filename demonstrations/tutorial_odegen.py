...
Learn about how ODEgen achieves this and convince yourself with a numerical demonstration in this demo.
...
.. note::
    ...
    Here, the shifts of :math:`\pm \frac{\pi}{2}` are only applied to differentiated parameters via the basis vectors :math:`\vec{e}_0 = (1,0,0,..)`, :math:`\vec{e}_1 = (0,1,0,..)` etc.
