...
This would yield a dimension of :math:`2046`, an increase of 31x (:math:`3100\%`).
...
case we can work in the significantly smaller vector space of first-order products (first "moments") of DLA elements, that are of size :math:`561` in
