...
is nothing more than a particular case of this technique. In this tutorial you will understand
the simple case and also you will learn to use some of its more powerful variants: Fixed-Point Amplitude Amplification
