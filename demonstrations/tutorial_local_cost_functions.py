...
by Cerezo, then its corresponding local cost function will always be 
...
#
# .. math:: C_{L} =  \langle | \psi(theta) | (I - \frac{1}{n} \sum_j |0\rangle \langle 0|_j) \rangle = 1-\sum_j p_{|0\rangle}_j.
#
