...
# operators, respectively. There are several ways to represent and construct a molecular vibrational
# Hamiltonian. Here we explain some of these representations and show how PennyLane features can be
# used to constructing the Hamiltonians.
#
...
#
# The Christiansen Hamiltonian is then constructed in second-quantization based on the potential
...
# part of both methods is to construct the potential energy operator. This is done by performing
