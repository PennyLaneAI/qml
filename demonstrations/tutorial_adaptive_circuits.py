...
the desired state and neglecting those that have a small contribution. You will also learn how to use
...
There are different ways to select the gates based on their gradients. Here we discuss one of
...
##############################################################################
# Similarly to the double excitation gates, we select those single excitations that have a gradient
