...
# 
# Another detail that is important to keep in mind for the actual practice
...
# estimate the ground state energy of the H\ :math:`_3^{+}` molecule, at
...
# Furthermore we have seen it in action varying the initial state
