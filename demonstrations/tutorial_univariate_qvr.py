...
#
# 
# Going left-to-right, a time series is sampled at three points in time, corresponding to a
...
# Hamiltonian operator (in practice, there are a distribution of such operators).
