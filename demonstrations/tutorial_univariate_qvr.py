...
#    :math:`t_1`, :math:`t_2` and :math:`t_3` corresponding to a
#    catepillar, a chrysalis and a butterfly: the life cycle of a butterfly.
#    This data is then encoded into quantum states and passed to a
...
# :math:`x \in X` (in fact this is impossible to do so exactly if each
