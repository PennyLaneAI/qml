...
Due to the adjoint identity from above, this also holds for group elements acting on
algebra elements:

.. math::

    K x K^\dagger = \exp(y) x \exp(-y) \in \mathfrak{m} &\forall x\in\mathfrak{m}, y\in\mathfrak{k},\\
    \exp(z) x \exp(-z) \in \mathfrak{k} &\forall x,z\in\mathfrak{m}.
...
of :math:`\mathfrak{su}(4)`, consisting of one copy of single-qubit operations acting
...
k_m_commutators = [k_op.pauli_rep.commutator(m_op.pauli_rep) for k_op, m_op in product(k, m)]
k_m_coms_in_m = [np.allclose([inner_product(com, k_op) for k_op in k], 0) for com in k_m_commutators]
...
m_m_commutators = [op1.pauli_rep.commutator(op2.pauli_rep) for op1, op2 in combinations(m, r=2)]
m_m_coms_in_k = [np.allclose([inner_product(com, m_op) for m_op in m], 0) for com in m_m_commutators]
...
The symmetric property of a Cartan decomposition tells us that :math:`\mathfrak{m}` is very
...
.. warning::
    ...
    In particular, there is a common notion of Cartan subalgebras that are not contained
...
.. math::
    ...
    [K x_1 K^\dagger, K x_2 K^\dagger] = K [x_1, x_2] K^\dagger = 0 \ \forall x_{1, 2}\in\mathfrak{h}.
...
For most :math:`y\in\mathfrak{k}`, this will yield a *different* CSA, so that we find a whole
continuum of subalgebras.
It turns out that *all* of them can be found by starting with *any*
:math:`\mathfrak{h}` and applying all :math:`\exp(y)\in K` to them.
...
.. note::
    ...
    .. math::
        ...
        &= \Pi_{\mathfrak{k}}(\underset{\underbrace{[\Pi_{\mathfrak{k}}(x), \Pi_{\mathfrak{k}}(y)]}}{\in \mathfrak{k}})
        \Pi_{\mathfrak{k}}(\underset{\underbrace{[\Pi_{\mathfrak{k}}(x), \Pi_{\mathfrak{m}}(y)]}}{\in \mathfrak{m}})
        \Pi_{\mathfrak{k}}(\underset{\underbrace{[\Pi_{\mathfrak{m}}(x), \Pi_{\mathfrak{k}}(y)]}}{\in \mathfrak{m}})
        \Pi_{\mathfrak{k}}(\underset{\underbrace{[\Pi_{\mathfrak{m}}(x), \Pi_{\mathfrak{m}}(y)]}}{\in \mathfrak{k}})\\
        ...
        &= \Pi_{\mathfrak{m}}(\underset{\underbrace{[\Pi_{\mathfrak{k}}(x), \Pi_{\mathfrak{k}}(y)]}}{\in \mathfrak{k}})
        \Pi_{\mathfrak{m}}(\underset{\underbrace{[\Pi_{\mathfrak{k}}(x), \Pi_{\mathfrak{m}}(y)]}}{\in \mathfrak{m}})
        \Pi_{\mathfrak{m}}(\underset{\underbrace{[\Pi_{\mathfrak{m}}(x), \Pi_{\mathfrak{k}}(y)]}}{\in \mathfrak{m}})
        \Pi_{\mathfrak{m}}(\underset{\underbrace{[\Pi_{\mathfrak{m}}(x), \Pi_{\mathfrak{m}}(y)]}}{\in \mathfrak{k}})\\
...
.. math::
    ...
    \theta_{\mathfrak{k}}^2=(\Pi_{\mathfrak{k}}-\Pi_{\mathfrak{m}})^2 = \Pi_{\mathfrak{k}}+\Pi_{\mathfrak{m}} = \mathbb{I}_{\mathfrak{g}},
