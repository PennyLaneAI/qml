...
make an approach to arithmetic in quantum computers using the quantum Fourier transform (QFT).
...
# #.  check if the product state is :math:`10101` and, in that case, change the sign,
