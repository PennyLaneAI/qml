...
For example, the molecular Hamiltonian can then be constructed for a water molecule:
"""
...
# an example. First, we define the PySCF molecule object and run a restricted Hartree-Fock
# calculation:
