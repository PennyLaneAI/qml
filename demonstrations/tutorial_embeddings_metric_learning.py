...
#           a pre-coded template. To use it, simply replace the cell above
...
#
# .. note:: You can use the utility function :func:`qaoa_embedding_normal`
#           to conveniently generate the correct shape of initial parameters for
